...
The Admin SDK also has the ability to update and delete accounts, which can be important to trigger when a user requests that all of their account information needs to be erased.
